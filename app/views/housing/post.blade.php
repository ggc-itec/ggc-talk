...
<form class="form-horizontal" action="{{ action('HousingController@handleAddPost') }}" method="post" role="form">
	<div class="form-group col-md-9" style="margin-right: 20px;">
		...
		{{ $errors->first('title', '<span class="error">*required</span>') }}
		{{ Form::text('title', null, ['class' => 'form-control']) }}
	</div>

	<div class="form-group col-md-2" style="margin-right: 5px;">
		{{ Form::label('city', 'City', ['class' => 'control-label']) }}
		{{ $errors->first('city', '<span class="error">*required</span>') }}
	...
	<div class="form-group col-md-12">
		...
		{{ $errors->first('body', '<span class="error">*required</span>') }}
	...
	<div class="form-group col-md-2" style="margin-right: 5px;">
		...
		{{ Form::text('rent', null, ['class' => 'form-control', 'placeholder' => '$ asking', 'style' => 'width: 125px;']) }}
	</div>
	...
	<div class="form-group col-md-3">
		...
		{{ $errors->first('bedrooms', '<span class="error">*required</span>') }}
